...
class OLI:
    def __init__(self, private_key: str=None, is_production: bool=True, custom_rpc_url: str=None) -> None:
        ...
        self.oli_label_trust_schema = '0xe65154ab871b1d82d0517ab5b718e62cdd33437487480b986a5724693c306c4f'
        ...
        self.trust_lists = self.graphql_client.create_trust_list_dict(self.graphql_client.graphql_query_trust_lists())

        print("...OLI client successfully initialized.")

    # Expose onchain attestation methods for OLI Label Pool & OLI Label Trust
    ...
    def submit_onchain_trust_list(self, owner: str, trusted: dict, untrusted: dict, gas_limit: int=0) -> tuple[str, str]:
        return self.onchain.submit_onchain_trust_list(owner, trusted, untrusted, gas_limit)

    # Expose offchain attestation methods for OLI Label Pool & OLI Label Trust
    ...
    def submit_offchain_trust_list(self, owner: str, trusted: dict, untrusted: dict, retry: int=4) -> Response:
        return self.offchain.submit_offchain_trust_list(owner, trusted, untrusted, retry)

    # Expose revocation methods for OLI Label Pool
    ...
    # Expose query methods for OLI Label Pool
    ...
    # Expose validation methods for OLI Label Pool
    ...
    # Expose trust list methods for OLI Label Trust
    def refresh_trust_lists(self) -> dict:
        self.trust_lists = self.graphql_client.create_trust_list_dict(self.graphql_client.graphql_query_trust_lists())
        return self.trust_lists

    ### TODO adjust for new style
    def validate_label_trust(self, owner: str, trusted: dict, untrusted: dict) -> bool:
        return self.validator.validate_label_trust(owner, trusted, untrusted)

    def filter_labels_by_trust_list(self, df: pd.DataFrame, trusted: list=None, untrusted: list=None, min_score: int=20, show_revoked: bool=False) -> pd.DataFrame:
        return self.utils_data.filter_labels_by_trust_list(df, trusted, untrusted, min_score, show_revoked)